import { reissueMediaUploadUrl } from "@/features/content/application/media-use-cases";
...
/** Reissue signed upload URL for uploading assets (same storageKey). */
export async function POST(request: Request, { params }: Params) {
  ...
  return runAdminMutation({
    ...
    async handler({ principal, requestId, data }) {
      ...
      const result = await reissueMediaUploadUrl(
        ports,
        {
