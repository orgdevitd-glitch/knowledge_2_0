...
Preview is temporary (`expiresAt`). Confirmation of expired preview is rejected.

Preview payload is normalized JSON: no Google tokens, no raw API dumps, size-limited.
